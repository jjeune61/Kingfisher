                      ...
                      <div class="card">
                        ...
                        @endif
                          ...
                          <div class="card-header">
                              ...
                              <a href="{{ url('/admin/roles/create') }}" class="btn btn-primary pull-right">
                                Create
                              </a>
                          </div>
                          <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href="{{ url('/admin/roles/edit/'.$role->id) }}" class="btn btn-primary">Edit</a>

                                    {{ Form::open(['method'=>'delete','url'=>['/admin/roles/delete/'. $role->id], 
