                      ...
                      <div class="card">
                        ...
                        @endif
                          ...
                          <div class="card-header">
                              ...
                              <a href="{{ url('/publication/eic/articles/create') }}" class="btn btn-primary pull-right">
                                Create
                              </a>
                          </div>
                          <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    {{ Form::open(['method'=>'put','url'=>['/publication/eic/articles/status/'. $article->id], 
                                  ...
                                  <td>
                                    {{ Form::open(['method'=>'put','url'=>['/publication/eic/articles/hot/news/'. $article->id], 
                                        'style'=>'display:inline']) }}
                                  ...
                                  <td>
                                    <a href="{{ url('/publication/eic/articles/edit/'.$article->id) }}" class="btn btn-primary">Edit</a>

                                    {{ Form::open(['method'=>'delete','url'=>['/publication/eic/articles/delete/'. $article->id], 
                                      'style'=>'display:inline']) }}
