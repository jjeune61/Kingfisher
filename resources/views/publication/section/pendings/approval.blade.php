    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Approval</strong>
            </div>
            <div class="card-body">
                <div id="pay-invoice">
                    <div class="card-body">
                        ...
                        @endif
                        <hr>
                        {{ Form::model($article, ['route' => ['sectionPending-approve', $article->id],'method'=>'put']) }} 
                        ...
                        {{ Form::model($article, ['route' => ['sectionPending-disapprove', $article->id],'method'=>'post']) }} 
